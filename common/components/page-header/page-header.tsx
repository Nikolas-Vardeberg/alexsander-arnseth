                ...
                <div className="col-span-2 md:col-span-1 mt-auto hidden sm:inline-block ">
                    <svg xmlns="http://www.w3.org/2000/svg" className="stroke-none mx-auto h-24 w-24 md:h-36 lg:h-48 md:w-36 lg:w-48"  viewBox="0 0 186 186" fill="none">
                        ...
                        <g clipPath="url(#clip1_199_733)">
                                <path d="M111.174 65.8241C116.134 69.1698 122.867 67.861 126.213 62.9008C129.559 57.9406 128.25 51.2073 123.29 47.8616C118.33 44.5159 111.596 45.8247 108.251 50.7849C104.905 55.7451 106.214 62.4784 111.174 65.8241Z" stroke="#54E240" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                                ...
                                <path d="M45.002 78.6865C40.8418 89.0359 40.3566 100.499 43.6272 111.163C46.8979 121.827 53.7265 131.047 62.9738 137.284C72.2211 143.521 83.3276 146.399 94.4403 145.437C105.553 144.474 115.999 139.73 124.037 131.996" stroke="#54E240" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
                            </g>
                        </g>
                        <defs>
